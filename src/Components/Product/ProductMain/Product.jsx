...
import './Product.css';
import { selectProductById } from '../../../Features/products/productApiSlice';
...
const Product = ({ id }) => {
  ...
  const [addCartItem, { isLoading, isError, error, data, isSuccess }] =
  ...
  const handleAddToCart = async () => {
    ...
    await addCartItem({ product_id: id, user_id, quantity });
    if (isSuccess) {
